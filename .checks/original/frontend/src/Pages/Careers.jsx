...
const jobs = [
    {
        ...
        icon: Code2,
        description:
            "Build modern, responsive and user-friendly web applications using React and modern frontend technologies.",
        skills: [
            "React",
            "JavaScript",
            "Tailwind CSS",
...

    {
        ...
        icon: Code2,
        description:
            "Develop reliable backend systems, APIs and database-driven applications that support real business solutions.",
        skills: [
            "Node.js",
            "Express",
            "MySQL",
        ...
        responsibilities: [
            ...
            "Write maintainable and scalable server-side code",
        ],
    },

    {
        ...
        icon: Laptop,
        description:
            "Create professional mobile applications that solve real-world problems and provide excellent user experiences.",
        skills: [
            "Flutter",
            "Dart",
            "REST APIs",
...

    {
        ...
        icon: Rocket,
        description:
            "Work with the team on practical AI, machine learning and data-driven technology projects.",
        skills: [
            "Python",
            "Machine Learning",
            "Data Analysis",
