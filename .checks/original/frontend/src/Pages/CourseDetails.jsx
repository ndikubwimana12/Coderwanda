...
const courses = [
    {
        ...
        description:
            "Learn how to design, develop and deploy modern websites and professional web applications.",
        duration: "3 Months",
        level: "Beginner → Advanced",
        students: "20+ Learners",
        image: codingClass,

        overview:
            "This practical Web Development program takes you from the fundamentals of web development to building complete professional websites and web applications.",
...

    {
        ...
        description:
            "Learn how to build modern mobile applications for Android and cross-platform environments.",
        duration: "3 Months",
        level: "Beginner → Advanced",
        students: "15+ Learners",
        image: students,

        overview:
            "Learn how to turn ideas into functional mobile applications through practical development projects and modern mobile technologies.",
...

    {
        ...
        shortTitle: "Python & Data Science",
        description:
            "Learn Python programming, data analysis, visualization and practical data science.",
        duration: "3 Months",
        level: "Intermediate",
        students: "15+ Learners",
        image: projectImage,
        ...
        overview:
            "Develop strong Python programming and data analysis skills while working with real-world datasets and practical projects.",
...

    {
        ...
        description:
            "Explore machine learning and artificial intelligence by building practical intelligent applications.",
        duration: "3 Months",
        level: "Intermediate",
        students: "10+ Learners",
        image: trainingHub,

        overview:
            "Learn the foundations of artificial intelligence and machine learning while developing practical AI-powered applications.",
...

    {
        ...
        description:
            "Develop practical knowledge of cybersecurity, networks, threats and security practices.",
        duration: "3 Months",
        level: "Beginner → Advanced",
        students: "15+ Learners",
        image: codingClass,
        ...
        overview:
            "Understand modern cybersecurity concepts and learn practical techniques for protecting systems, networks and applications.",
...

    {
        ...
        description:
            "Learn how to design databases and develop reliable backend systems and APIs.",
        duration: "2 Months",
        level: "Intermediate",
        students: "10+ Learners",
        image: projectImage,
        ...
        overview:
            "Learn how modern applications store, process and exchange information through databases, backend systems and APIs.",
...
export default function CourseDetails() {
    ...
    useEffect(() => {
        ...
        api.get(`/courses/${courseId}`)
            .then(r => {
                const apiCourse = r.data;
                // Merge API data with static fallback for rich detail fields
                const staticFallback = courses.find(
                    item => item.id === Number(courseId) || item.slug === courseId || item.slug === apiCourse?.slug
                );
                setCourse({ ...staticFallback, ...apiCourse });
            })
            .catch(() => {
                // Fall back to static
                const found = courses.find(
                    item => item.id === Number(courseId) || item.slug === courseId
                );
        ...
        <main className="min-h-screen bg-white text-slate-900">
            ...
            <section className="bg-slate-950 py-20">
                ...
                <div className="mx-auto max-w-5xl px-6 text-center">
                    ...
                    <Link
                        to={`/training-room/enroll/${course.id}`}
