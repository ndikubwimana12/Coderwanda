...
const FALLBACK_IMAGES = [codingClass, students, projectImage, trainingHub, codingClass, projectImage];

const STATIC_COURSES = [
    { id: 1, slug: "web-development",        title: "Web Development",          description: "Learn how to build modern, responsive and professional websites and web applications.", duration: "3 Months", level: "Beginner → Advanced", image: codingClass,    icon: Code2 },
    { id: 2, slug: "mobile-app-development",  title: "Mobile App Development",   description: "Build beautiful Android and cross-platform applications using modern development tools.", duration: "3 Months", level: "Beginner → Advanced", image: students,       icon: Smartphone },
    { id: 3, slug: "python-data-science",     title: "Python & Data Science",    description: "Learn Python programming, data analysis, visualization and practical data science.",    duration: "3 Months", level: "Intermediate",         image: projectImage,   icon: Brain },
    { id: 4, slug: "artificial-intelligence", title: "Artificial Intelligence",  description: "Explore machine learning and AI by building practical intelligent applications.",      duration: "3 Months", level: "Intermediate",         image: trainingHub,    icon: Brain },
    { id: 5, slug: "cybersecurity",           title: "Cybersecurity",            description: "Develop practical knowledge of cybersecurity, networks, threats and security practices.", duration: "3 Months", level: "Beginner → Advanced", image: codingClass,    icon: ShieldCheck },
    { id: 6, slug: "database-backend",        title: "Database & Backend",       description: "Learn how to design databases and develop reliable backend systems and APIs.",           duration: "2 Months", level: "Intermediate",         image: projectImage,   icon: Database },
];

const projects = [
    "E-commerce platforms", "Business management systems", "Mobile applications",
    "AI-powered applications", "Professional websites", "Database-driven systems",
];

const testimonials = [
    { name: "Student Success",  course: "Web Development", text: "The practical approach helped me understand programming by actually building projects." },
    { name: "Future Developer", course: "Software Development", text: "I learned how to turn an idea into a working application from planning to development." },
    { name: "Tech Learner",     course: "Python & AI", text: "The training environment encouraged me to keep learning and working on real projects." },
];
...
export default function TrainingRoom() {
    ...
    useEffect(() => {
        api.get("/courses")
            .then(r => {
                if (r.data?.length > 0) {
                    const mapped = r.data.map((c, i) => ({
                        ...c,
                        image: c.image || FALLBACK_IMAGES[i % FALLBACK_IMAGES.length],
