...
import { Users, ShoppingCart, GraduationCap, DollarSign, Package, Phone, CheckCircle2, Server, Database, FileSpreadsheet } from "lucide-react";
              ...
              {chartData.map((h, i) => (
                <div key={i} className="group relative flex-1 flex flex-col items-center justify-end h-full">
                  <div
                    ...
                    style={{
                      height: `${(h / Math.max(1, ...chartData)) * 100}%`,
                      background: h === Math.max(...chartData)
