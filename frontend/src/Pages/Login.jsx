...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(redirect?.startsWith('/') && !redirect.startsWith('//') ? redirect : data.user.admin_access ? '/admin' : data.user.is_trainer ? '/teach' : data.user.is_student ? '/learn' : '/ecommerce');
        } catch (err) {
