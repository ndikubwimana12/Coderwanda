...
app.post('/api/auth/login', async (req, res) => {
  ...
  if (!rows.length || !rows[0].account_active || !await bcrypt.compare(req.body.password, rows[0].password)) fail('Invalid email or password.', 401);
